...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nameEditText2.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {}
            override fun onTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                communicationViewModel!!.setGender(charSequence.toString())
            }
            override fun afterTextChanged(editable: Editable) {}
        })
        val nameEditText3 = view.findViewById<TextInputEditText>(R.id.textInputTextName3)
        nameEditText3.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {}
            override fun onTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                communicationViewModel!!.setPesan(charSequence.toString())
            }
            override fun afterTextChanged(editable: Editable) {}
        })
    }
